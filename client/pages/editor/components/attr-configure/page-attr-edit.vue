<template>
    <el-scrollbar class="components-attr-edit">
        ...
        <div class="attr-item-edit-wrapper">
            <p class="attr-item-title">主题颜色：</p>
            <div class="attr-item-edit-input no-top">
                <el-select v-model="activePage.theme"
                           placeholder=""
                           @change="theme">
        ...
        <div class="attr-item-edit-wrapper">
            <p class="attr-item-title">图片适配：</p>
            <div class="attr-item-edit-input">
                <el-select v-model="activePage.commonStyle.backgroundSize"
                           placeholder=""
                           @change="changeValue">
                    <el-option label="充满容器"
                               value="cover"></el-option>
                    <el-option label="自适应填充"
                               value="contain"></el-option>
                    <el-option label="真实大小"
...
export default {
    ...
    methods: {
        changeValue () {
            // console.log(this.activePage.commonStyle.backgroundSize)
        },
        theme (type) {

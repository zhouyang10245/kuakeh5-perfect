    ...
    <div class="components-page-manage scrollbar-wrapper">
        ...
        <el-scrollbar style="height: 100%;"
            ...
            <div class="page-item clearfix"
                ...
                <div class="inline-block" @dblclick="editIndex = index">
                    <span class="page-item-index">{{index + 1}}</span>
                    <el-input v-if='editIndex == index' @blur="changename" v-model="item.name" style="width:130px"></el-input>
                    <template v-else>
                        {{item.name || '第' + (index + 1) + '页'}}
                    </template>
                </div>
                <div class="page-item-btn-wrapper pull-right width20">
                    <el-dropdown>
                        ...
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item>
                                <div class="btn-item"
                                     @click="copyPage(item)"><i class="el-icon-document-copy"></i> 复制页面</div>
                            </el-dropdown-item>
                            <el-dropdown-item>
                                <div class="btn-item"
                                     @click="addPage(item)"><i class="el-icon-document-add"></i> 新增页面</div>
                            </el-dropdown-item>
                            <el-dropdown-item>
                                <div class="btn-item"
                                     @click="deletePage(item)"><i class="el-icon-delete"></i> 删除页面</div>
                            </el-dropdown-item>
                        </el-dropdown-menu>
                    </el-dropdown>
                </div>

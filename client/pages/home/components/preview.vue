        ...
        <div class="preview-info-wrapper"
            ...
            <el-form label-width="90px"
                ...
                <el-form-item label="页面二维码:">
                    <QrcodeVue :value="pageLink"
                               :size="120"
                               level="H"></QrcodeVue>
                    <p v-if="!pageData.isPublish"
                       class="gray fontsize-12 lineheight-18">注意：为防范钓鱼安全风险，预览内容仅供作者调试使用，有效期 50 分钟，如需供他人预览，请使用发布功能。</p>
                </el-form-item>
                <el-form-item label="页面链接:">
                    <div>
                        <el-button type="primary"
                                   @click="doCopy">复制链接</el-button>
                    </div>
            ...
            <div class="page-info">
                <div class="page-cover">
                    <img :src="shareData.coverImage || defaultCoverImage"
                         alt="">
                </div>

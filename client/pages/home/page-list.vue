            ...
            <ul class="page-item-wrapper">
                ...
                <li class="page-item"
                    ...
                    <span class="unpublish"
                          v-if="!item.isPublish">未发布</span>
                    <!-- <div class="header-mask">
                        <div class="details-btn"
                             @click="showPreviewFn(item._id)">预览</div>
                    </div> -->
                    <div class="cover">
                        <img :src="item.coverImage || defaultCoverImage"
                             alt="">
                    </div>
                    ...
                    <div class="page-item-data-pv border-T">
                        <div class="btn-wrapper">
                            <el-button type="text"
                                       size="mini"
                                       @click="editPage(index+1)">编辑</el-button>
                        </div>
                        <!-- <div class="btn-wrapper">
                            <el-button type="text"
                                       size="mini"
                                       @click="copyPage(item._id)">复制</el-button>
                        </div> -->
                        <div class="btn-wrapper">
                            ...
                            <el-dropdown placement="top-start">
                                <span class="el-dropdown-link">
                                    <el-button type="text"
                                               size="mini">更多 <i class="el-icon-more-outline"></i></el-button>
                                </span>
...
export default {
    ...
    computed:{
        ...mapState({
            projectList: state => state.editor.projectList
        })
    },
    methods: {
        /**
         ...
         */
        editPage (id) {
            this.$router.push({ path: 'editorPc', query: { id: id } })
        },
        /**
         * 复制页面
         */
